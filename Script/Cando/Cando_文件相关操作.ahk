...
Cando_Folder2txt:
file := FileOpen(CandySel "\目录列表.txt", "rw")
Loop, %CandySel%\*.*, 2, 1 ; Folders only
{
	...
	file.WriteLine(A_LoopFileLongPath)
}
file.Close()
return
...
if(GetKeyState("Shift"))
	Mode_OpenFolder:=1
Menu, %Candy_Cmd_Str3%, add, % (Mode_OpenFolder?"打开 ":"移动到 ") Candy_Cmd_Str3, Cando_CutToFolder
...
CandySel := Candy_Cmd_Str3 := Mode_OpenFolder := ""
return
