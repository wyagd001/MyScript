...
*/
Cando_查新版帮助:
	; 在设置中 ahk新版中文帮助 的变量中设置
	;ahk新版中文帮助=D:\Program Files\AutoHotkey\AutoHotkeyLCN_New.chm
...
;有doc可打开
	if RegExMatch(Ahk关键字表,Ahk被查关键字)
	{
		IfWinNotExist,%Ahk帮助标题%
		{
			...
			if !DllCall("HHCtrl.ocx\HtmlHelp", "Ptr", hGui, "str", ahk新版中文帮助, "UInt", 0x000D, "ptr", &ak)
			{
				Run, %ahk新版中文帮助%
				WinWait,%Ahk帮助标题%,,5
				WinActivate,%Ahk帮助标题%
