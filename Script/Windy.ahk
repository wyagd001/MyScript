...
; 
;  [···················································]
	;Windy_All_Cmd := "config|Windo|Winfunc|Wingo|Keys|SetClipBoard|AlwaysOnTop|bottom|Send|SendStr|MsgBox|mute|open|Close|unclose|CloseAll|Kill|exit|RunOrClose|RunOrActivate|RunOntop|run|"
	...
	{
		Sendinput % Splitted_Windy_Cmd2
		return
	}
	Else If(RegExMatch(Windy_Cmd, "i)^(SendStr\|)")) ; 如果是以SendStr|开头，则是发送字串
	{
