...
Array_WriteMenuToINI(InputArray,sectionINI, fileName)
{
	...
	Loop % InputArray.Length()
	{
		...
		IfInString, k, ::{
		{
			...
			StringReplace, tmp_k, k,::{031E4825-7B94-4DC3-B131-E946B44C8DD5}\
