; https://autohotkey.com/board/topic/20996-auto-raise-mouse-hover/
...
GetMouseTaskButton(ByRef hwnd)
{
	...
	if (cl = "MSTaskListWClass"  ; Windows 7: the methods used below won't work.
		...
		|| DllCall("IsWow64Process", "Uint", DllCall("GetCurrentProcess"), "intP", iswow64)
		&& iswow64)  ; OS/taskbar is 64-bit - not compatible.
	{
		hwnd := 0
		return 1
	}
