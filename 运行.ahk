...
Menu, ConfigMenu1, Add, 退出(&X)`t, TM_Exit
...
Else
{
	if (A_ThisLabel = "显示主窗口") && !WinActive(AppTitle)
...
ClassTpye := "CabinetWClass,ExploreWClass,Notepad2,Notepad,IEFrame,ACDViewer,Afx_,ShImgVw_,#32770,"
